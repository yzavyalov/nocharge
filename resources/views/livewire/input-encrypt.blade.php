<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
        ...
        <div class="mt-4 flex items-center">
            ...
            <button class="ml-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" wire:click="submit">
                Submit
            </button>
        </div>
        ...
        <div class="mt-2">
            ...
            <div class="flex items-center">
                <div class="flex-grow" id="hashedValue">{{$hashedEmail}}</div>
